...
const buttonClasses = computed(() => {
  ...
  const variants = {
    primary: "bg-[#162842] text-white hover:bg-green-700 focus:ring-green-500",
    secondary: "bg-gray-600 text-white hover:bg-gray-700 focus:ring-gray-500",
    outline:
      "border-2 border-gray-800 text-gray-800 hover:bg-gray-100 focus:ring-gray-500",
...
<template>
  <button :class="buttonClasses" :disabled="disabled || loading" type="button">
    <!-- Loading Spinner -->
    <svg
      v-if="loading"
